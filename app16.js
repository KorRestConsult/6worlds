...
(function(){
  ...
  const tours={
    ...
    'manager-home':[
      ...
      {sel:'.employee-compact',title:'Теперь откройте сотрудника',text:'После подсказки нажмите первую карточку сотрудника. Внутри увидите, из чего складывается рейтинг и сможете назначить проверку.',action:true}
    ],
    'employee-detail':[
