// UX / consistency pass: no new product mechanics, only map alignment and interaction fixes.
(function(){
  const blockMap={
...
function openEmployeeManager(id){
  state.currentEmployee=id;save();const e=emp(id);
